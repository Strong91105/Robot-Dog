...
#include "pc_interfaces/msg/detail/student__rosidl_typesupport_fastrtps_c.h"
...
using _Student__ros_msg_type = pc_interfaces__msg__Student;
...
static uint32_t _Student__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_pc_interfaces__msg__Student(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = pc_interfaces__msg__Student;
    is_plain =
      (
...
static size_t _Student__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_pc_interfaces__msg__Student(
