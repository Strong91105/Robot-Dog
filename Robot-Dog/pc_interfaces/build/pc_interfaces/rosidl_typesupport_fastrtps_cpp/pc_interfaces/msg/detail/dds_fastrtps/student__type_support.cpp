...
#include "pc_interfaces/msg/detail/student__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const pc_interfaces::msg::Student & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  pc_interfaces::msg::Student & ros_message)
{
  // Member: structure_needs_at_least_one_member
  cdr >> ros_message.structure_needs_at_least_one_member;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = pc_interfaces::msg::Student;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const pc_interfaces::msg::Student *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<pc_interfaces::msg::Student *>(
    untyped_ros_message);
...
{
  return &pc_interfaces::msg::typesupport_fastrtps_cpp::_Student__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pc_interfaces, msg, Student)() {
  return &pc_interfaces::msg::typesupport_fastrtps_cpp::_Student__handle;
}
