...
class LidarSubscriber(Node):
    ...
    def lidar_callback(self, msg):
        ...
        threshold_z_axis = -0.30 # TODO
        threshold_x_axis = 0.42 #TODO
        ...
        left_wall = left_wall[(left_wall[:, 1] > threshold_y_axis) & (left_wall[:, 1] < 0.48)]   # Y-axis
        right_wall = wall_points.copy()
        right_wall = right_wall[(right_wall[:, 1] < -threshold_y_axis) & (right_wall[:, 1] > -0.48)] # Y-axis
