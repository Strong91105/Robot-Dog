...
bool pc_interfaces__msg__student__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("pc_interfaces.msg._student.Student", full_classname_dest, 34) == 0);
  }
  pc_interfaces__msg__Student * ros_message = _ros_message;
...
PyObject * pc_interfaces__msg__student__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("pc_interfaces.msg._student");
