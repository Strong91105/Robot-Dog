...
class WallFollower(Node):
    def __init__(self):
        ...
        self.kp_lateral = 0.6   # How hard to push back to center CHANGE
        self.kp_angular = 0.6   # How hard to steer straight CHANGE
    ...
    def listener_callback(self, msg):
        ...
        # 2. FIX ORIENTATION (The 'Yaw' rotation)
        # If the robot is slanted, rotate it back to 0
        cmd.angular.z = -(self.kp_angular * angle_error)

        # 3. FORWARD SPEED (Optional)
        # Set this to 0.1 or 0.2 if you want it to move while centering
        cmd.linear.x = 0.0 
